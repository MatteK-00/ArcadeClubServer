"""
Django settings for arcadeclub project.
...
SECRET_KEY = '^zju*l!th%h3sx$dpu!cy*ckkuwlp$558qfkb6o9p8t4e0h=)h'
...
WSGI_APPLICATION = 'arcadeclub.wsgi.application'
